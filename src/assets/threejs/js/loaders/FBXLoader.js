...
// THREE.FBXLoader = ( function () {
	...
	FBXLoader.prototype = {
      ...
      console.log('FBXloader load begins. ')
			var self = this;
      console.log('self is ', self)
			var resourceDirectory = THREE.LoaderUtils.extractUrlBase( url );
      console.log('resourceDirectory is ', resourceDirectory)
      console.log('this.manager is ', this.manager)
			...
			loader.load( url, function ( buffer ) {
				...
				try {
          console.log('loader.load try. ') // buffer is ', buffer)
      ...
      console.log('parse begins. FBXBuffer is ', FBXBuffer)
      console.log('isFbxFormatBinary( FBXBuffer ) is ', isFbxFormatBinary( FBXBuffer ))
			...
			console.log( 'fbxTree is ', fbxTree );
		...
		parseImage: function ( videoNode ) {
			...
			switch ( extension ) {
				...
				case 'tga':
					...
					if ( typeof TGALoader !== 'function' ) { // typeof THREE.TGALoader !== 'function'
