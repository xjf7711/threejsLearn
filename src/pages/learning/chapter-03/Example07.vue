<template>
  <div class="example">
    <h2>Example 03.07 - Lensflarest</h2>
  </div>
</template>
...
import LensFlare from '@/assets/threejs/js/objects/LensFlare'
export default {
  name: 'Example0307',
  data() {
    return {
  ...
  methods: {
    init() {
      ...
      const textureFlare0 = textureLoader.load('static/threejs/learning/textures/lensflare/lensflare0.png')
      const textureFlare3 = textureLoader.load('static/threejs/learning/textures/lensflare/lensflare3.png')
