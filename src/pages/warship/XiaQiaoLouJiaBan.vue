...
export default {
  name: 'Jianjiaban',
  mixins: [clearWebGLContext, stats, windowResize, animate],
  data() {
    return {
      scene: null,
      camera: null,
  ...
  methods: {
    ...
    initMouseControls() {
      ...
      // 最大最小相机移动距离(景深相机)
      this.mouseCtrols.minDistance = 10
      this.mouseCtrols.maxDistance = 800
      // How far you can orbit vertically, upper and lower limits.
      // Range is 0 to Math.PI radians.
      // 最大仰视角和俯视角
      this.mouseCtrols.minPolarAngle = 0.01 * Math.PI // radians
