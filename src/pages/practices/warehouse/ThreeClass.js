...
export default class ThreeClass {
  ...
  */
  constructor(_fId, _option, _datajson) {
    this.dbclick = 0
    // this.commonFunc = {}
    this.mouseClick = new THREE.Vector2()
    console.log('this.mouseClick is ', this.mouseClick)
    ...
    // 对象
    console.log('initObj3D _fId is ', _fId)
    this.fId = _fId
    ...
    this.objList = _datajson // 对象列表 _datajson.objects
  ...
  initRenderer() {
    ...
    console.log('this.fId is ', this.fId)
  ...
  initHelpGrid() {
    ...
    console.log('initHelpGrid begins. this.option.showHelpGrid is ', this.option.showHelpGrid)
  ...
  createCube(_this, _obj) {
    ...
    // const cubeMaterials = new THREE.MeshFaceMaterial(cubeMaterialArray)
    const cube = new THREE.Mesh(cubeGeometry, cubeMaterialArray) // cubeMaterials
  ...
  addBtns(_btnobjs) {
    ...
    if (_btnobjs != null && _btnobjs.length > 0) {
      ...
      toolbar.id = 'toolbar'
      document.getElementById(this.fId).appendChild(toolbar)
  ...
  addTestObj() {
    ...
    //        this.addObject(model);
    //    });
    // const plane = this.createPlaneGeometry(this, {
    //   width: 100,
    //   height: 200,
    //   pic: 'static/threejs/resource/glass.png', // ../datacenterdemo/res/glass.png
    //   transparent: true,
    //   opacity: 1,
    //   position: {
    //     x: 0,
