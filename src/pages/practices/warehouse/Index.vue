...
export default {
  ...
  mounted() {
    ...
    for (let i = 1; i <= 36; i++) {
      objList.push({
        ...
        position: { x: 595 + 90 * i, y: -95, z: 140 + 40 * i },
        showSortNub: 54
      })
      ...
      objList.push({
        ...
        objType: 'GroupObj',
        scale: { x: 1.5, y: 1, z: 1.2 },
        position: { x: 595 + 90 * i, y: -95, z: 140 },
        showSortNub: 54
      })
    }
  ...
  methods: {
    ...
    initRenderer() {
      ...
      this.renderer.setClearColor(this.option.clearColor, 1.0) // 设置窗口背景颜色为this.option.clearColor
    ...
    initMouseControls() {
      ...
      // 最大最小相机移动距离(景深相机)
      this.mouseCtrols.minDistance = 400
      ...
      this.mouseCtrols.rotateSpeed = 3.0

      // Set to false to disable panning
      // 是否可平移，默认移动速度为7px
      this.mouseCtrols.enablePan = true
      this.mouseCtrols.keyPanSpeed = 3.0	// pixels moved per arrow key push
    ...
    initGui() {
      ...
      datGui.domElement.style.right = '6px'
