<template>
  <div class="example">
    <h2>Example 02.01 - Basic Scene</h2>
  </div>
</template>
    ...
    init() {
      ...
      this.controls = {
        ...
        addCube: () => {
          ...
          cube.position.x = -10 + Math.round((Math.random() * this.planeGeometry.parameters.width))
          cube.position.y = Math.round((Math.random() * 5))
          cube.position.z = -5 + Math.round((Math.random() * this.planeGeometry.parameters.height))
