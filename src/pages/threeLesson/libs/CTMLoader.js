...
THREE.CTMLoader.prototype.createModelClassic = function(file, callback) {
  var Model = function() {
    ...
    if (file.body.normals !== undefined) { init_normals(file.body.normals) }

    if (file.body.uvMaps !== undefined && file.body.uvMaps.length > 0) { init_uvs(file.body.uvMaps[ 0 ].uv) }

    if (file.body.attrMaps !== undefined && file.body.attrMaps.length > 0 && file.body.attrMaps[ 0 ].name === 'Color') { init_colors(file.body.attrMaps[ 0 ].attr) }
