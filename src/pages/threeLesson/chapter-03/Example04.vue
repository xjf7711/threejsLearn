<template>
  <div class="example">
    <h2>Example 03.05 - Directional Light</h2>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      ...
      directionalLight.shadow.mapSize.height = 1024 // shadowMapHeight = 1024
      directionalLight.shadow.mapSize.width = 1024 // shadowMapWidth = 1024
      ...
      sphereLightMesh.position.set(new THREE.Vector3(3, 20, 3)) // new THREE.Vector3(3, 20, 3)
      ...
      gui.add(controls, 'debug').onChange(function(e) {
        directionalLight.CameraHelper = e // shadowCameraVisible = e;
      })
    ...
    render() {
      ...
      sphereLightMesh.position.y = +(27 * (Math.sin(this.step / 3)))
      sphereLightMesh.position.x = 10 + (26 * (Math.cos(this.step / 3)))

      this.directionalLight.position.copy(sphereLightMesh.position)
