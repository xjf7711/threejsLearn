<template>
  <div class="example">
    <h2>102 THREE.JS 使用几何体生成拱门形状</h2>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    initModels() {
      ...
      const geometry = new THREE.BoxGeometry(100, 5, 3, 400, 1)
    ...
    initMouseControls() {
      ...
      this.mouseCtrols.maxDistance = 600
      // How far you can orbit vertically, upper and lower limits.
      // Range is 0 to Math.PI radians.
      // 最大仰视角和俯视角
      this.mouseCtrols.minPolarAngle = 0.1 * Math.PI // radians
      this.mouseCtrols.maxPolarAngle = 0.6 * Math.PI // radians
