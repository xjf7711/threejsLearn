...
export const guideRouterMap = [
  ...
  //   name: 'guide-index',
  //   title: '目录',
  //   component: () => import('@/pages/guide/index/Index'),
  //   hidden: true
  // },
  {
    path: '/guide',
    ...
    name: 'Guide',
    // redirect: '/threejsGuide/index',
    meta: { title: 'Guide', icon: 'table', noCache: true },
    children: [
      {
        path: 'index',
        component: () => import('@/pages/guide/index/Index'),
        ...
        children: [
          {
            path: 'index',
            name: 'preface-index',
            component: () => import('@/pages/guide/preface/Index.vue'),
        ...
        children: [
          {
            ...
            name: 'chapter1-index',
            title: 'introduction',
            component: () => import('@/pages/guide/chapter1/Index.vue'),
          ...
          },
          {
            ...
            name: 'example1-1-1',
            title: 'example1-1',
            component: () => import('@/pages/guide/chapter1/1.1.1.vue'),
          ...
          },
          {
            ...
            name: 'example1-2-1',
            title: 'example2-1',
            component: () => import('@/pages/guide/chapter1/1.2.1.vue'),
        ...
        children: [
          {
            ...
            name: 'chapter2-index',
            title: 'introduction',
            component: () => import('@/pages/guide/chapter2/Index.vue'),
            meta: { title: 'introduction', icon: 'table', noCache: true }
          },
          {
            path: '1',
            name: 'example2-3-1',
            title: 'example2-3-1',
            component: () => import('@/pages/guide/chapter2/2.3.1.vue'),
          ...
          },
          {
            ...
            name: 'example2-4-1',
            title: 'example4-1',
            component: () => import('@/pages/guide/chapter2/2.4.1.vue'),
        ...
        children: [
          {
            ...
            name: 'chapter3-index',
            title: 'introduction',
            component: () => import('@/pages/guide/chapter3/Index.vue'),
            meta: { title: 'introduction', icon: 'table', noCache: true }
          },
          {
            path: '1',
            name: 'example3-1-1',
            component: () => import('@/pages/guide/chapter3/3.1.1.vue'),
            meta: { title: 'example3-1-1', icon: 'table', noCache: true }
          },
          {
            path: '2',
            name: 'example3-2-1',
            component: () => import('@/pages/guide/chapter3/3.2.1.vue'),
            meta: { title: 'example3-2-1', icon: 'table', noCache: true }
          },
          {
            path: '3',
            name: 'example3-3-1',
            component: () => import('@/pages/guide/chapter3/3.3.1.vue'),
        ...
        children: [
          {
            ...
            name: 'chapter4-index',
            title: 'introduction',
            component: () => import('@/pages/guide/chapter4/Index.vue'),
            meta: { title: 'introduction', icon: 'table', noCache: true }
          },
          {
            path: '1',
            name: 'example4-1-1',
            component: () => import('@/pages/guide/chapter4/4.1.1.vue'),
            meta: { title: 'example4-1-1', icon: 'table', noCache: true }
          },
          {
            path: '2',
            name: 'example4-2-1',
            component: () => import('@/pages/guide/chapter4/4.2.1.vue'),
            meta: { title: 'example4-2-1', icon: 'table', noCache: true }
          },
          {
            path: '3',
            name: 'example4-3-1',
            component: () => import('@/pages/guide/chapter4/4.3.1.vue'),
            meta: { title: 'example4-3-1', icon: 'table', noCache: true }
          },
          {
            path: '4',
            name: 'example4-4-1',
            component: () => import('@/pages/guide/chapter4/4.4.1.vue'),
            meta: { title: 'example4-4-1', icon: 'table', noCache: true }
          },
          {
            path: '5-1',
            name: 'example4-5-1',
            component: () => import('@/pages/guide/chapter4/4.5.1.vue'),
            meta: { title: 'example4-5-1', icon: 'table', noCache: true }
          },
          {
            path: '5-2',
            name: 'example4-5-2',
            component: () => import('@/pages/guide/chapter4/4.5.2.vue'),
            meta: { title: 'example4-5-2', icon: 'table', noCache: true }
          },
          {
            path: '5-3',
            name: 'example4-5-3',
            component: () => import('@/pages/guide/chapter4/4.5.3.vue'),
        ...
        children: [
          {
            ...
            name: 'chapter5-index',
            title: 'introduction',
            component: () => import('@/pages/guide/chapter5/Index.vue'),
            meta: { title: 'introduction', icon: 'table', noCache: true }
          },
          {
            path: '1',
            name: 'example5-1-1',
            component: () => import('@/pages/guide/chapter5/5.1.1.vue'),
            meta: { title: 'example5-1-1', icon: 'table', noCache: true }
          },
          {
            path: '2-1',
            name: 'example5-2-1',
            component: () => import('@/pages/guide/chapter5/5.2.1.vue'),
            meta: { title: 'example5-2-1', icon: 'table', noCache: true }
          },
          {
            path: '2-2',
            name: 'example5-2-2',
            component: () => import('@/pages/guide/chapter5/5.2.2.vue'),
        ...
        children: [
          {
            ...
            name: 'chapter6-index',
            title: 'introduction',
            component: () => import('@/pages/guide/chapter6/Index.vue'),
            meta: { title: 'introduction', icon: 'table', noCache: true }
          },
          {
            path: '1-1',
            name: 'example6-1-1',
            component: () => import('@/pages/guide/chapter6/6.1.1.vue'),
            meta: { title: 'example6-1-1', icon: 'table', noCache: true }
          },
          {
            path: '1-2',
            name: 'example6-1-2',
            component: () => import('@/pages/guide/chapter6/6.1.2.vue'),
            meta: { title: 'example6-1-2', icon: 'table', noCache: true }
          },
          {
            path: '2-1',
            name: 'example6-2-1',
            component: () => import('@/pages/guide/chapter6/6.2.1.vue'),
            meta: { title: 'example6-2-1', icon: 'table', noCache: true }
          },
          {
            path: '2-2',
            name: 'example6-2-2',
            component: () => import('@/pages/guide/chapter6/6.2.2.vue'),
            meta: { title: 'example6-2-2', icon: 'table', noCache: true }
          },
          {
            path: '3',
            name: 'dropball6-3-1',
            component: () => import('@/pages/guide/chapter6/6.3.1.vue'),
        ...
        children: [
          {
            ...
            name: 'chapter7-index',
            title: 'introduction',
            component: () => import('@/pages/guide/chapter7/Index.vue'),
            meta: { title: 'introduction', icon: 'table', noCache: true }
          },
          {
            path: '2',
            name: 'example7-2-1',
            component: () => import('@/pages/guide/chapter7/7.2.1.vue'),
            meta: { title: 'example7-2-1', icon: 'table', noCache: true }
          },
          {
            path: '3-1',
            name: 'example7-3-1',
            component: () => import('@/pages/guide/chapter7/7.3.1.vue'),
            meta: { title: 'example7-3-1', icon: 'table', noCache: true }
          },
          {
            path: '3-2',
            name: 'example7-3-2',
            component: () => import('@/pages/guide/chapter7/7.3.2.vue'),
            meta: { title: 'example7-3-2', icon: 'table', noCache: true }
          },
          {
            path: '3-3',
            name: 'example7-3-3',
            component: () => import('@/pages/guide/chapter7/7.3.3.vue'),
        ...
        children: [
          {
            ...
            name: 'chapter8-index',
            title: 'introduction',
            component: () => import('@/pages/guide/chapter8/Index.vue'),
            meta: { title: 'introduction', icon: 'table', noCache: true }
          },
          {
            path: 'example8-1-1',
            name: 'example8-1-1',
            component: () => import('@/pages/guide/chapter8/8.1.1.vue'),
            meta: { title: 'example8-1-1', icon: 'table', noCache: true }
          },
          {
            path: 'example8-1-2',
            name: 'example8-1-2',
            component: () => import('@/pages/guide/chapter8/8.1.2.vue'),
            meta: { title: 'example8-1-2', icon: 'table', noCache: true }
          },
          {
            path: 'example8-1-3',
            name: 'example8-1-3',
            component: () => import('@/pages/guide/chapter8/8.1.3.vue'),
            meta: { title: 'example8-1-3', icon: 'table', noCache: true }
          },
          {
            path: 'example8-2-1',
            name: 'example8-2-1',
            component: () => import('@/pages/guide/chapter8/8.2.1.vue'),
            meta: { title: 'example8-2-1', icon: 'table', noCache: true }
          },
          {
            path: 'example8-3-1',
            name: 'example8-3-1',
            component: () => import('@/pages/guide/chapter8/8.3.1.vue'),
            meta: { title: 'example8-3-1', icon: 'table', noCache: true }
          },
          {
            path: 'example8-4-1',
            name: 'example8-4-1',
            component: () => import('@/pages/guide/chapter8/8.4.1.vue'),
            meta: { title: 'example8-4-1', icon: 'table', noCache: true }
          },
          {
            path: 'example8-5-1',
            name: 'example8-5-1',
            component: () => import('@/pages/guide/chapter8/8.5.1.vue'),
        ...
        children: [
          {
            ...
            name: 'chapter9-index',
            title: 'introduction',
            component: () => import('@/pages/guide/chapter9/Index.vue'),
            meta: { title: 'introduction', icon: 'table', noCache: true }
          },
          {
            path: 'example9-3-1',
            name: 'example9-3-1',
            component: () => import('@/pages/guide/chapter9/9.3.1.vue'),
